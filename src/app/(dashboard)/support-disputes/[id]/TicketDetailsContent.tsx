...
export default function TicketDetailsContent({ id }: { id: string }) {
    ...
    const messagesList = useMemo(() => {
        const list = (messagesResponse?.data || []) as LocalMessage[];
                ...
                <div className="xl:col-span-8 space-y-6">
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8 space-y-4 h-[680px] flex flex-col">
                        ...
                        {!isClosed ? (
                            ...
                            <div className="p-4 bg-green-50/50 rounded-xl border border-green-100 text-center text-xs font-bold text-green-800 shrink-0">
